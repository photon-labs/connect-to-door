...
- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType isBackgroundClickable:(BOOL)isBackgroundClickable
{
    ...
    [self presentPopupView:popupViewController.view animationType:animationType isBackgroundClickable:(BOOL)isBackgroundClickable];
}
...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType isBackgroundClickable:(BOOL)isBackgroundClickable
{
    UIView *sourceView = [self topView];
